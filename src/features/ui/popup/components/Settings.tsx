        ...
        <div style={styles.usageBox}>
          ...
          <div style={styles.usageItem}>
            <div style={styles.usageHeader}>
              ...
              <span style={styles.usageCount}>
                {explanationsToday} / {isPlus ? '∞' : `${explanationsLimit}`}
              </span>
            </div>
            {!isPlus && (
              <div style={styles.progressBar}>
          ...
          {(wordsToday >= wordsLimit || explanationsToday >= explanationsLimit) && !apiKey && !isPlus && (
            <p style={styles.limitWarning}>
              Daily limit reached. Add your own API key for unlimited usage.
            </p>
          )}
          {isPlus && (
            <p style={styles.plusStatus}>
              ✨ Fluent+ - Unlimited translations & explanations
            </p>
          )}
        </div>
